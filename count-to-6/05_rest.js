...
We'll test your module by passing it a few different sets of arguments, e.g. average(1, 2, 3) and average(5, 10), and making sure that it works in all cases. Otherwise, the process is the same as before: use count-to-6 verify program.js to test your result, and so on.
*/

module.exports = function average(...args){
  var sum = args.reduce( (pv, cv) => pv + cv)
  // var sum = 0;
